...
<body>
  ...
  <div class="container">
          ...
          <div class="card  col col-xl-8 shadow rounded">
            ...
            <div class="card-body">
              ...
              <form action="" method="post" id="insert-data">
                ...
                <?php if ($INSPECTION_RESULT == null || $CHECK_DATE == null) { ?>
    ...
    if (isset($_POST['submit'])) {
      ...
      if (oci_execute($objParse, OCI_COMMIT_ON_SUCCESS) && $hyghienicStatus) {
        ...
        //         });
        //         </script>';
        echo "<script type='text/javascript'>alert('บันทึกข้อมูลผิดพลาด');
        window.location.href='http://10.2.2.5/sfifix/reportReceTran.php?documentNo=$EG_RECE_DOCUMENT'
        </script>";
      }
